...
// Here's my DoubleLinkedList Functions
{
    var emptyDLL = new DLList();
    var oneDLL = new DLList();
    var MyDLL = new DLList();
    // console.log(emptyDLL.isEmpty());
    // oneDLL.append(42);
    // console.log(oneDLL.isEmpty());
    // emptyDLL.prepend(5).printList().append(3).printList();
    MyDLL.append(8).append(6).append(7).append(5).append(3).append(0).append(9);
    // MyDLL.prepend(42).printList();
    MyDLL.push(15,0).printList();
}